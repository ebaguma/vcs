...
Class ProjectPapList {
    ...
    function SearchPaps() {
        ...
        while ($row = $result -> fetch_object()) {
            ...
            $ACTION = '../ui/ui_pap_info.php?Mode=Read&ProjectID=' . $_GET['ProjectID'] . '&ProjectCode=' . $_GET['ProjectCode'] . '&HHID=' . $HHID . '#PAP';
            $DEL_URL = '../ui/ui_pap_info.php?Mode=DeletePap&ProjectID=' . $_GET['ProjectID'] . '&ProjectCode=' . $_GET['ProjectCode'] . '&HHID=' . $HHID . '#PAP';
            $DEL_ACTION = '<a href="' . $DEL_URL . '" ><img src="images/delete.png" alt="" class="EditDeleteButtons" /></a>';
