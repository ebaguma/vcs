		...
		<div class="Content">
			...
			<!-- div class="SearchPap">
                    ...
                    <div class="GridArea" id="Reload">
                        <form>
                            <fieldset class="fieldset" style="height:700px; width:1000px; padding: 30px">
                                ...
                                <table id="uiProjectListTable" class="display compact" style="width:100%; padding: 10px 0px">
                                    <thead>
                                        <tr>
