...
<<<<<<< HEAD
								<table class="detailNavigation">
									<tr>
										<td><a href="<?php
                                            if (isset($_GET['StaffID'])) { echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?Mode=ViewExpense&ProjectID=' . $_GET['ProjectID'] . '&ProjectCode=' . $_GET['ProjectCode'] . '&ExpenseID=' . $_GET['ExpenseID'] . '&ExpCat=' . $_GET['ExpCat'] . '&ExpSubCat=' . $_GET['ExpSubCat'] . '&ExpensePage=' . $GLOBALS['expense_prev_page'] . '#Expenses';
                                            } else { echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?Mode=Read&ProjectID=' . $_GET['ProjectID'] . '&ProjectCode=' . $_GET['ProjectCode'] . '&ExpensePage=' . $GLOBALS['expense_prev_page'] . '#Expenses'; }
                                            ?>" >Previous</a></td>
                                            <td class="PageJump" style="width: 70px;"> <?php echo $expense_load_page; ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php echo $expense_num_pages; ?></td>
                                            <td><a href="<?php
...
<<<<<<< HEAD
										...
										style="width: 610px;">Enter Name e.g FirstName LastName <a
											...
											class="LinkInBox SideBar" href="#">Search</a> </span></td>
									</tr>
									<tr>
										<td class="formLabel">PAP Reference No</td>
										<td class="formLabel">Land Plot Reference No</td>
									</tr>
									<tr>
...
<<<<<<< HEAD
								...
								<table class="detailNavigation">
									<tr>
										...
										<td class="PageJump" style="width: 70px;">1 / 5</td>
										<td><a href="#">Next</a></td>
									</tr>
								</table>
=======
